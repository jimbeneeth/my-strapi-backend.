...
export interface ApiStudentFormStudentForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateofApplication: Schema.Attribute.Date;
    ...
    subject: Schema.Attribute.Enumeration<
      ['General Enquiry', 'Technical Support', 'Admission', 'Feedback']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
